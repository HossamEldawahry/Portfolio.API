...
namespace Portfolio.API.Repositories
{
    public class MessageRepository : IMessageRepository
    {
        ...
        public async Task AddAsync(Message data)
        {
            data.CreatedAt = DateTime.UtcNow;
            await _context.Messages.AddAsync(data).ConfigureAwait(false);
        }
        ...
        public async Task<IEnumerable<Message>> GetAllAsync() =>
            await _context.Messages.OrderByDescending(m => m.CreatedAt).ToListAsync().ConfigureAwait(false);
        ...
        public async Task<Message?> GetFirstAsync() =>
            await _context.Messages.OrderByDescending(m => m.CreatedAt).FirstOrDefaultAsync().ConfigureAwait(false);
